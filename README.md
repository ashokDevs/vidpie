...
MIT for vidpie's own code, see [LICENSE](./LICENSE). Remotion itself is used under its [free license](https://github.com/remotion-dev/remotion/blob/main/LICENSE.md).
